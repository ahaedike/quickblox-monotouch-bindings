...
namespace QuickBlox {
	[Register("BinaryResult", true)]
	public unsafe partial class BinaryResult : Result {
		[CompilerGenerated]
		const string selData = "data";
		static readonly IntPtr selDataHandle = Selector.GetHandle ("data");
		
		[CompilerGenerated]
		static readonly IntPtr class_ptr = Class.GetHandle ("BinaryResult");
		...
		[Export ("init")]
		public BinaryResult () : base (NSObjectFlag.Empty)
		{
		...
		public BinaryResult (NSCoder coder) : base (NSObjectFlag.Empty)
		{
		...
		[CompilerGenerated]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		public BinaryResult (NSObjectFlag t) : base (t)
		{
			IsDirectBinding = GetType ().Assembly == global::ApiDefinition.Messaging.this_assembly;
		}
		...
		[CompilerGenerated]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		public BinaryResult (IntPtr handle) : base (handle)
		{
			IsDirectBinding = GetType ().Assembly == global::ApiDefinition.Messaging.this_assembly;
		}
