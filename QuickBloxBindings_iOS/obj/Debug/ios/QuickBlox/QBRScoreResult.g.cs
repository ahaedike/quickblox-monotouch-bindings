...
namespace QuickBlox {
	[Register("QBRScoreResult", true)]
	public unsafe partial class QBRScoreResult : Result {
		[CompilerGenerated]
		const string selScore = "score";
		static readonly IntPtr selScoreHandle = Selector.GetHandle ("score");
		
		[CompilerGenerated]
		static readonly IntPtr class_ptr = Class.GetHandle ("QBRScoreResult");
		...
		[Export ("init")]
		public QBRScoreResult () : base (NSObjectFlag.Empty)
		{
		...
		public QBRScoreResult (NSCoder coder) : base (NSObjectFlag.Empty)
		{
		...
		[CompilerGenerated]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		public QBRScoreResult (NSObjectFlag t) : base (t)
		{
			IsDirectBinding = GetType ().Assembly == global::ApiDefinition.Messaging.this_assembly;
		}
		...
		[CompilerGenerated]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		public QBRScoreResult (IntPtr handle) : base (handle)
		{
			IsDirectBinding = GetType ().Assembly == global::ApiDefinition.Messaging.this_assembly;
		}
