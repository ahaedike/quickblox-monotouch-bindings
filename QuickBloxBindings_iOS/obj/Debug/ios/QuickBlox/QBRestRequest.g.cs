...
namespace QuickBlox {
	...
	public unsafe partial class QBRestRequest : NSObject {
		...
		[CompilerGenerated]
		const string selHttpMethod_ = "httpMethod:";
		static readonly IntPtr selHttpMethod_Handle = Selector.GetHandle ("httpMethod:");
		[CompilerGenerated]
		...
		[CompilerGenerated]
		public virtual void AsyncRequestWithdelegate (NSObject del)
		{
			if (del == null)
				throw new ArgumentNullException ("del");
			if (IsDirectBinding) {
				MonoTouch.ObjCRuntime.Messaging.void_objc_msgSend_IntPtr (this.Handle, selAsyncRequestWithdelegate_Handle, del.Handle);
			} else {
				MonoTouch.ObjCRuntime.Messaging.void_objc_msgSendSuper_IntPtr (this.SuperHandle, selAsyncRequestWithdelegate_Handle, del.Handle);
			}
		}
		
		[Export ("httpMethod:")]
		[CompilerGenerated]
		public static string HttpMethod (RestMethodKind method)
		{
			return NSString.FromHandle (MonoTouch.ObjCRuntime.Messaging.IntPtr_objc_msgSend_int (class_ptr, selHttpMethod_Handle, (int)method));
		}
		...
		public virtual RestMethodKind Method {
			...
			get {
				if (IsDirectBinding) {
					return (RestMethodKind) MonoTouch.ObjCRuntime.Messaging.int_objc_msgSend (this.Handle, selMethodHandle);
				} else {
					return (RestMethodKind) MonoTouch.ObjCRuntime.Messaging.int_objc_msgSendSuper (this.SuperHandle, selMethodHandle);
				}
			}
			...
			set {
				if (IsDirectBinding) {
					MonoTouch.ObjCRuntime.Messaging.void_objc_msgSend_int (this.Handle, selSetMethod_Handle, (int)value);
				} else {
					MonoTouch.ObjCRuntime.Messaging.void_objc_msgSendSuper_int (this.SuperHandle, selSetMethod_Handle, (int)value);
				}
			}
		}
		...
		public virtual RestRequestBuildStyle BuildStyle {
			...
			get {
				if (IsDirectBinding) {
					return (RestRequestBuildStyle) MonoTouch.ObjCRuntime.Messaging.int_objc_msgSend (this.Handle, selBuildStyleHandle);
				} else {
					return (RestRequestBuildStyle) MonoTouch.ObjCRuntime.Messaging.int_objc_msgSendSuper (this.SuperHandle, selBuildStyleHandle);
				}
			}
			...
			set {
				if (IsDirectBinding) {
					MonoTouch.ObjCRuntime.Messaging.void_objc_msgSend_int (this.Handle, selSetBuildStyle_Handle, (int)value);
				} else {
					MonoTouch.ObjCRuntime.Messaging.void_objc_msgSendSuper_int (this.SuperHandle, selSetBuildStyle_Handle, (int)value);
				}
			}
		}
