...
namespace QuickBlox {
	[Register("QBRGameModeAnswer", true)]
	public unsafe partial class QBRGameModeAnswer : EntityAnswer {
		[CompilerGenerated]
		const string selGamemode = "gamemode";
		static readonly IntPtr selGamemodeHandle = Selector.GetHandle ("gamemode");
		
		[CompilerGenerated]
		static readonly IntPtr class_ptr = Class.GetHandle ("QBRGameModeAnswer");
		...
		[Export ("init")]
		public QBRGameModeAnswer () : base (NSObjectFlag.Empty)
		{
		...
		public QBRGameModeAnswer (NSCoder coder) : base (NSObjectFlag.Empty)
		{
		...
		[CompilerGenerated]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		public QBRGameModeAnswer (NSObjectFlag t) : base (t)
		{
			IsDirectBinding = GetType ().Assembly == global::ApiDefinition.Messaging.this_assembly;
		}
		...
		[CompilerGenerated]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		public QBRGameModeAnswer (IntPtr handle) : base (handle)
		{
			IsDirectBinding = GetType ().Assembly == global::ApiDefinition.Messaging.this_assembly;
		}
