...
namespace QuickBlox {
	[Register("QBCOCustomObjectPagedResult", true)]
	public unsafe partial class QBCOCustomObjectPagedResult : Result {
		[CompilerGenerated]
		...
		[CompilerGenerated]
		static readonly IntPtr class_ptr = Class.GetHandle ("QBCOCustomObjectPagedResult");
		...
		[Export ("init")]
		public QBCOCustomObjectPagedResult () : base (NSObjectFlag.Empty)
		{
		...
		public QBCOCustomObjectPagedResult (NSCoder coder) : base (NSObjectFlag.Empty)
		{
		...
		[CompilerGenerated]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		public QBCOCustomObjectPagedResult (NSObjectFlag t) : base (t)
		{
			IsDirectBinding = GetType ().Assembly == global::ApiDefinition.Messaging.this_assembly;
		}
		...
		[CompilerGenerated]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		public QBCOCustomObjectPagedResult (IntPtr handle) : base (handle)
		{
			IsDirectBinding = GetType ().Assembly == global::ApiDefinition.Messaging.this_assembly;
		}
	...
	} /* class QBCOCustomObjectPagedResult */
}
