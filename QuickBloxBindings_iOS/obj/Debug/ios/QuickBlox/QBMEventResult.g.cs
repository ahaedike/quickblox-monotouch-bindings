...
namespace QuickBlox {
	[Register("QBMEventResult", true)]
	public unsafe partial class QBMEventResult : Result {
		[CompilerGenerated]
		const string selEvent = "event";
		static readonly IntPtr selEventHandle = Selector.GetHandle ("event");
		
		[CompilerGenerated]
		static readonly IntPtr class_ptr = Class.GetHandle ("QBMEventResult");
		...
		[Export ("init")]
		public QBMEventResult () : base (NSObjectFlag.Empty)
		{
		...
		public QBMEventResult (NSCoder coder) : base (NSObjectFlag.Empty)
		{
		...
		[CompilerGenerated]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		public QBMEventResult (NSObjectFlag t) : base (t)
		{
			IsDirectBinding = GetType ().Assembly == global::ApiDefinition.Messaging.this_assembly;
		}
		...
		[CompilerGenerated]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		public QBMEventResult (IntPtr handle) : base (handle)
		{
			IsDirectBinding = GetType ().Assembly == global::ApiDefinition.Messaging.this_assembly;
		}
