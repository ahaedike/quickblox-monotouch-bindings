...
namespace QuickBlox {
	[Register("PagedQuery", true)]
	public unsafe partial class PagedQuery : QBQuery {
		[CompilerGenerated]
		...
		[CompilerGenerated]
		const string selInit = "init";
		static readonly IntPtr selInitHandle = Selector.GetHandle ("init");
		
		[CompilerGenerated]
		static readonly IntPtr class_ptr = Class.GetHandle ("PagedQuery");
		...
		[Export ("init")]
		public PagedQuery () : base (NSObjectFlag.Empty)
		{
		...
		public PagedQuery (NSCoder coder) : base (NSObjectFlag.Empty)
		{
		...
		[CompilerGenerated]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		public PagedQuery (NSObjectFlag t) : base (t)
		{
			IsDirectBinding = GetType ().Assembly == global::ApiDefinition.Messaging.this_assembly;
		}
		...
		[CompilerGenerated]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		public PagedQuery (IntPtr handle) : base (handle)
		{
			IsDirectBinding = GetType ().Assembly == global::ApiDefinition.Messaging.this_assembly;
		}
			...
			: base (NSObjectFlag.Empty)
		{
			IsDirectBinding = GetType ().Assembly == global::ApiDefinition.Messaging.this_assembly;
			if (IsDirectBinding) {
				InitializeHandle (MonoTouch.ObjCRuntime.Messaging.IntPtr_objc_msgSend (this.Handle, selInitHandle), "init");
			} else {
				InitializeHandle (MonoTouch.ObjCRuntime.Messaging.IntPtr_objc_msgSendSuper (this.SuperHandle, selInitHandle), "init");
			}
		}
