...
namespace QuickBlox {
	...
	public unsafe partial class QBCBlob : Entity {
		...
		[CompilerGenerated]
		const string selStatusFromString_ = "statusFromString:";
		static readonly IntPtr selStatusFromString_Handle = Selector.GetHandle ("statusFromString:");
		[CompilerGenerated]
		const string selStatusToString_ = "statusToString:";
		static readonly IntPtr selStatusToString_Handle = Selector.GetHandle ("statusToString:");
		...
		[Export ("statusFromString:")]
		[CompilerGenerated]
		public static QBCBlobStatus StatusFromString (string status)
		{
			if (status == null)
			...
			QBCBlobStatus ret;
			ret = (QBCBlobStatus) MonoTouch.ObjCRuntime.Messaging.int_objc_msgSend_IntPtr (class_ptr, selStatusFromString_Handle, nsstatus);
		...
		[CompilerGenerated]
		public static string StatusToString (QBCBlobStatus status)
		{
			return NSString.FromHandle (MonoTouch.ObjCRuntime.Messaging.IntPtr_objc_msgSend_int (class_ptr, selStatusToString_Handle, (int)status));
		}
