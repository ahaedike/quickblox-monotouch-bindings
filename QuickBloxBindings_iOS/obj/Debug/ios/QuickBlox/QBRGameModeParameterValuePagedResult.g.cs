...
namespace QuickBlox {
	[Register("QBRGameModeParameterValuePagedResult", true)]
	public unsafe partial class QBRGameModeParameterValuePagedResult : PagedResult {
		[CompilerGenerated]
		...
		[CompilerGenerated]
		static readonly IntPtr class_ptr = Class.GetHandle ("QBRGameModeParameterValuePagedResult");
		...
		[Export ("init")]
		public QBRGameModeParameterValuePagedResult () : base (NSObjectFlag.Empty)
		{
		...
		public QBRGameModeParameterValuePagedResult (NSCoder coder) : base (NSObjectFlag.Empty)
		{
		...
		[CompilerGenerated]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		public QBRGameModeParameterValuePagedResult (NSObjectFlag t) : base (t)
		{
			IsDirectBinding = GetType ().Assembly == global::ApiDefinition.Messaging.this_assembly;
		}
		...
		[CompilerGenerated]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		public QBRGameModeParameterValuePagedResult (IntPtr handle) : base (handle)
		{
			IsDirectBinding = GetType ().Assembly == global::ApiDefinition.Messaging.this_assembly;
		}
	...
	} /* class QBRGameModeParameterValuePagedResult */
}
