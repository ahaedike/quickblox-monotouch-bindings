...
namespace QuickBlox {
	[Register("QBLPlaceResult", true)]
	public unsafe partial class QBLPlaceResult : Result {
		[CompilerGenerated]
		const string selPlace = "place";
		static readonly IntPtr selPlaceHandle = Selector.GetHandle ("place");
		
		[CompilerGenerated]
		static readonly IntPtr class_ptr = Class.GetHandle ("QBLPlaceResult");
		...
		[Export ("init")]
		public QBLPlaceResult () : base (NSObjectFlag.Empty)
		{
		...
		public QBLPlaceResult (NSCoder coder) : base (NSObjectFlag.Empty)
		{
		...
		[CompilerGenerated]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		public QBLPlaceResult (NSObjectFlag t) : base (t)
		{
			IsDirectBinding = GetType ().Assembly == global::ApiDefinition.Messaging.this_assembly;
		}
		...
		[CompilerGenerated]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		public QBLPlaceResult (IntPtr handle) : base (handle)
		{
			IsDirectBinding = GetType ().Assembly == global::ApiDefinition.Messaging.this_assembly;
		}
