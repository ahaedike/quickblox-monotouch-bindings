...
namespace QuickBlox {
	[Register("QBRGameModeParameterValueResult", true)]
	public unsafe partial class QBRGameModeParameterValueResult : Result {
		[CompilerGenerated]
		...
		[CompilerGenerated]
		static readonly IntPtr class_ptr = Class.GetHandle ("QBRGameModeParameterValueResult");
		...
		[Export ("init")]
		public QBRGameModeParameterValueResult () : base (NSObjectFlag.Empty)
		{
		...
		public QBRGameModeParameterValueResult (NSCoder coder) : base (NSObjectFlag.Empty)
		{
		...
		[CompilerGenerated]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		public QBRGameModeParameterValueResult (NSObjectFlag t) : base (t)
		{
			IsDirectBinding = GetType ().Assembly == global::ApiDefinition.Messaging.this_assembly;
		}
		...
		[CompilerGenerated]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		public QBRGameModeParameterValueResult (IntPtr handle) : base (handle)
		{
			IsDirectBinding = GetType ().Assembly == global::ApiDefinition.Messaging.this_assembly;
		}
	...
	} /* class QBRGameModeParameterValueResult */
}
