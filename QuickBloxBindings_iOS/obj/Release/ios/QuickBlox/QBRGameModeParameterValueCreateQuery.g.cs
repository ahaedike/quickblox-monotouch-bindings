...
namespace QuickBlox {
	[Register("QBRGameModeParameterValueCreateQuery", true)]
	public unsafe partial class QBRGameModeParameterValueCreateQuery : QBRGameModeParameterValueQuery {
		[CompilerGenerated]
		...
		[CompilerGenerated]
		static readonly IntPtr class_ptr = Class.GetHandle ("QBRGameModeParameterValueCreateQuery");
		...
		[Export ("init")]
		public QBRGameModeParameterValueCreateQuery () : base (NSObjectFlag.Empty)
		{
		...
		public QBRGameModeParameterValueCreateQuery (NSCoder coder) : base (NSObjectFlag.Empty)
		{
		...
		[CompilerGenerated]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		public QBRGameModeParameterValueCreateQuery (NSObjectFlag t) : base (t)
		{
			IsDirectBinding = GetType ().Assembly == global::ApiDefinition.Messaging.this_assembly;
		}
		...
		[CompilerGenerated]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		public QBRGameModeParameterValueCreateQuery (IntPtr handle) : base (handle)
		{
			IsDirectBinding = GetType ().Assembly == global::ApiDefinition.Messaging.this_assembly;
		}
		...
		[CompilerGenerated]
		public QBRGameModeParameterValueCreateQuery (QBRGameModeParameterValue gameModeParameterValue)
	...
	} /* class QBRGameModeParameterValueCreateQuery */
}
