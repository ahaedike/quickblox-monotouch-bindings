...
namespace QuickBlox {
	[Register("QBMGetTokenTaskResult", true)]
	public unsafe partial class QBMGetTokenTaskResult : TaskResult {
		[CompilerGenerated]
		...
		[CompilerGenerated]
		static readonly IntPtr class_ptr = Class.GetHandle ("QBMGetTokenTaskResult");
		...
		[Export ("init")]
		public QBMGetTokenTaskResult () : base (NSObjectFlag.Empty)
		{
		...
		public QBMGetTokenTaskResult (NSCoder coder) : base (NSObjectFlag.Empty)
		{
		...
		[CompilerGenerated]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		public QBMGetTokenTaskResult (NSObjectFlag t) : base (t)
		{
			IsDirectBinding = GetType ().Assembly == global::ApiDefinition.Messaging.this_assembly;
		}
		...
		[CompilerGenerated]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		public QBMGetTokenTaskResult (IntPtr handle) : base (handle)
		{
			IsDirectBinding = GetType ().Assembly == global::ApiDefinition.Messaging.this_assembly;
		}
