...
namespace QuickBlox {
	[Register("QBLGeoDataResult", true)]
	public unsafe partial class QBLGeoDataResult : Result {
		[CompilerGenerated]
		const string selGeoData = "geoData";
		static readonly IntPtr selGeoDataHandle = Selector.GetHandle ("geoData");
		
		[CompilerGenerated]
		static readonly IntPtr class_ptr = Class.GetHandle ("QBLGeoDataResult");
		...
		[Export ("init")]
		public QBLGeoDataResult () : base (NSObjectFlag.Empty)
		{
		...
		public QBLGeoDataResult (NSCoder coder) : base (NSObjectFlag.Empty)
		{
		...
		[CompilerGenerated]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		public QBLGeoDataResult (NSObjectFlag t) : base (t)
		{
			IsDirectBinding = GetType ().Assembly == global::ApiDefinition.Messaging.this_assembly;
		}
		...
		[CompilerGenerated]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		public QBLGeoDataResult (IntPtr handle) : base (handle)
		{
			IsDirectBinding = GetType ().Assembly == global::ApiDefinition.Messaging.this_assembly;
		}
