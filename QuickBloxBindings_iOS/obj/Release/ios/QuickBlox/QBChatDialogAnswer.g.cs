...
namespace QuickBlox {
	[Register("QBChatDialogAnswer", true)]
	public unsafe partial class QBChatDialogAnswer : XmlAnswer {
		[CompilerGenerated]
		...
		[CompilerGenerated]
		static readonly IntPtr class_ptr = Class.GetHandle ("QBChatDialogAnswer");
		...
		[Export ("init")]
		public QBChatDialogAnswer () : base (NSObjectFlag.Empty)
		{
		...
		public QBChatDialogAnswer (NSCoder coder) : base (NSObjectFlag.Empty)
		{
		...
		[CompilerGenerated]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		public QBChatDialogAnswer (NSObjectFlag t) : base (t)
		{
			IsDirectBinding = GetType ().Assembly == global::ApiDefinition.Messaging.this_assembly;
		}
		...
		[CompilerGenerated]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		public QBChatDialogAnswer (IntPtr handle) : base (handle)
		{
			IsDirectBinding = GetType ().Assembly == global::ApiDefinition.Messaging.this_assembly;
		}
