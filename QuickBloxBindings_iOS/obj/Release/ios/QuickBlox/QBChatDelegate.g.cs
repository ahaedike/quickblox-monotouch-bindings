...
namespace QuickBlox {
	...
	public static class QBChatDelegate_Extensions {
		...
		[CompilerGenerated]
		public static void Type (this IQBChatDelegate This, global::System.UInt32 userID, string type)
		{
			if (type == null)
		...
		[CompilerGenerated]
		public static void FromRoom (this IQBChatDelegate This, QBChatMessage message, string roomName)
		{
			if (message == null)
				throw new ArgumentNullException ("message");
			if (roomName == null)
		...
		[CompilerGenerated]
		public static void Room (this IQBChatDelegate This, NSDictionary information, string roomName)
		{
			if (information == null)
		...
		[CompilerGenerated]
		public static void Error (this IQBChatDelegate This, string roomName, NSError error)
		{
			if (roomName == null)
				throw new ArgumentNullException ("roomName");
			if (error == null)
		...
		[CompilerGenerated]
		public static void RoomChange (this IQBChatDelegate This, NSObject[] onlineUsers, string roomName)
		{
			if (onlineUsers == null)
		...
		[CompilerGenerated]
		public static void RoomUsers (this IQBChatDelegate This, NSObject[] users, string roomName)
		{
			if (users == null)
		...
		[CompilerGenerated]
		public static void RoomOnline (this IQBChatDelegate This, NSObject[] users, string roomName)
		{
			if (users == null)
				throw new ArgumentNullException ("users");
			if (roomName == null)
		...
		[CompilerGenerated]
		public static void WithSessionID (this IQBChatDelegate This, global::System.UInt32 userID, string sessionID, QBVideoChatConferenceType conferenceType)
		{
			if (sessionID == null)
				throw new ArgumentNullException ("sessionID");
			var nssessionID = NSString.CreateNative (sessionID);
			
			ApiDefinition.Messaging.void_objc_msgSend_UInt32_IntPtr_int (This.Handle, Selector.GetHandle ("chatDidReceiveCallRequestFromUser:withSessionID:conferenceType:"), userID, nssessionID, (int)conferenceType);
			NSString.ReleaseNative (nssessionID);
			
		}
		
		[CompilerGenerated]
		public static void WithSessionID (this IQBChatDelegate This, global::System.UInt32 userID, string sessionID, QBVideoChatConferenceType conferenceType, NSDictionary customParameters)
		{
			if (sessionID == null)
				throw new ArgumentNullException ("sessionID");
			...
			ApiDefinition.Messaging.void_objc_msgSend_UInt32_IntPtr_int_IntPtr (This.Handle, Selector.GetHandle ("chatDidReceiveCallRequestFromUser:withSessionID:conferenceType:customParameters:"), userID, nssessionID, (int)conferenceType, customParameters.Handle);
			NSString.ReleaseNative (nssessionID);
		...
		[CompilerGenerated]
		public static void CustomParameters (this IQBChatDelegate This, global::System.UInt32 userID, NSDictionary customParameters)
		{
			if (customParameters == null)
				throw new ArgumentNullException ("customParameters");
		...
		[CompilerGenerated]
		public static void Status (this IQBChatDelegate This, global::System.UInt32 userID, string status)
		{
			if (status == null)
				throw new ArgumentNullException ("status");
			var nsstatus = NSString.CreateNative (status);
		...
		[CompilerGenerated]
		public static void Status (this IQBChatDelegate This, global::System.UInt32 userID, string status, NSDictionary customParameters)
		{
			if (status == null)
				throw new ArgumentNullException ("status");
			if (customParameters == null)
		...
		[CompilerGenerated]
		public static void SessionID (this IQBChatDelegate This, global::System.UInt32 userID, string sessionID)
		{
			if (sessionID == null)
				throw new ArgumentNullException ("sessionID");
			var nssessionID = NSString.CreateNative (sessionID);
		...
		[CompilerGenerated]
		public static void TotalSteps (this IQBChatDelegate This, global::System.UInt32 step, global::System.UInt32 totalSteps)
		{
