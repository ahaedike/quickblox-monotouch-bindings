...
namespace QuickBlox {
	[Register("QBMEventAnswer", true)]
	public unsafe partial class QBMEventAnswer : EntityAnswer {
		[CompilerGenerated]
		const string selEvent = "event";
		static readonly IntPtr selEventHandle = Selector.GetHandle ("event");
		
		[CompilerGenerated]
		static readonly IntPtr class_ptr = Class.GetHandle ("QBMEventAnswer");
		...
		[Export ("init")]
		public QBMEventAnswer () : base (NSObjectFlag.Empty)
		{
		...
		public QBMEventAnswer (NSCoder coder) : base (NSObjectFlag.Empty)
		{
		...
		[CompilerGenerated]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		public QBMEventAnswer (NSObjectFlag t) : base (t)
		{
			IsDirectBinding = GetType ().Assembly == global::ApiDefinition.Messaging.this_assembly;
		}
		...
		[CompilerGenerated]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		public QBMEventAnswer (IntPtr handle) : base (handle)
		{
			IsDirectBinding = GetType ().Assembly == global::ApiDefinition.Messaging.this_assembly;
		}
