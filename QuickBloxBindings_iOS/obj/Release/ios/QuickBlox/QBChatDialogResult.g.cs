...
namespace QuickBlox {
	[Register("QBChatDialogResult", true)]
	public unsafe partial class QBChatDialogResult : Result {
		[CompilerGenerated]
		const string selDialog = "dialog";
		static readonly IntPtr selDialogHandle = Selector.GetHandle ("dialog");
		
		[CompilerGenerated]
		static readonly IntPtr class_ptr = Class.GetHandle ("QBChatDialogResult");
		...
		[Export ("init")]
		public QBChatDialogResult () : base (NSObjectFlag.Empty)
		{
		...
		public QBChatDialogResult (NSCoder coder) : base (NSObjectFlag.Empty)
		{
		...
		[CompilerGenerated]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		public QBChatDialogResult (NSObjectFlag t) : base (t)
		{
			IsDirectBinding = GetType ().Assembly == global::ApiDefinition.Messaging.this_assembly;
		}
		...
		[CompilerGenerated]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		public QBChatDialogResult (IntPtr handle) : base (handle)
		{
			IsDirectBinding = GetType ().Assembly == global::ApiDefinition.Messaging.this_assembly;
		}
