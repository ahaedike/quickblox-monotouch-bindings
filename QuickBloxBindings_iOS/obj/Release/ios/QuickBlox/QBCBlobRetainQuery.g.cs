...
namespace QuickBlox {
	[Register("QBCBlobRetainQuery", true)]
	public unsafe partial class QBCBlobRetainQuery : QBCBlobQuery {
		[CompilerGenerated]
		...
		[CompilerGenerated]
		static readonly IntPtr class_ptr = Class.GetHandle ("QBCBlobRetainQuery");
		...
		[Export ("init")]
		public QBCBlobRetainQuery () : base (NSObjectFlag.Empty)
		{
		...
		public QBCBlobRetainQuery (NSCoder coder) : base (NSObjectFlag.Empty)
		{
		...
		[CompilerGenerated]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		public QBCBlobRetainQuery (NSObjectFlag t) : base (t)
		{
			IsDirectBinding = GetType ().Assembly == global::ApiDefinition.Messaging.this_assembly;
		}
		...
		[CompilerGenerated]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		public QBCBlobRetainQuery (IntPtr handle) : base (handle)
		{
			IsDirectBinding = GetType ().Assembly == global::ApiDefinition.Messaging.this_assembly;
		}
		...
		[CompilerGenerated]
		public QBCBlobRetainQuery (global::System.UInt32 blobid)
