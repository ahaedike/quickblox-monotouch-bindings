...
namespace QuickBlox {
	[Register("QBRScoreAnswer", true)]
	public unsafe partial class QBRScoreAnswer : EntityAnswer {
		[CompilerGenerated]
		const string selScore = "score";
		static readonly IntPtr selScoreHandle = Selector.GetHandle ("score");
		
		[CompilerGenerated]
		static readonly IntPtr class_ptr = Class.GetHandle ("QBRScoreAnswer");
		...
		[Export ("init")]
		public QBRScoreAnswer () : base (NSObjectFlag.Empty)
		{
		...
		public QBRScoreAnswer (NSCoder coder) : base (NSObjectFlag.Empty)
		{
		...
		[CompilerGenerated]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		public QBRScoreAnswer (NSObjectFlag t) : base (t)
		{
			IsDirectBinding = GetType ().Assembly == global::ApiDefinition.Messaging.this_assembly;
		}
		...
		[CompilerGenerated]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		public QBRScoreAnswer (IntPtr handle) : base (handle)
		{
			IsDirectBinding = GetType ().Assembly == global::ApiDefinition.Messaging.this_assembly;
		}
