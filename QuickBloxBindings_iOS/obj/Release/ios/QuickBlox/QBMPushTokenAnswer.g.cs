...
namespace QuickBlox {
	[Register("QBMPushTokenAnswer", true)]
	public unsafe partial class QBMPushTokenAnswer : EntityAnswer {
		[CompilerGenerated]
		const string selPushToken = "pushToken";
		static readonly IntPtr selPushTokenHandle = Selector.GetHandle ("pushToken");
		
		[CompilerGenerated]
		static readonly IntPtr class_ptr = Class.GetHandle ("QBMPushTokenAnswer");
		...
		[Export ("init")]
		public QBMPushTokenAnswer () : base (NSObjectFlag.Empty)
		{
		...
		public QBMPushTokenAnswer (NSCoder coder) : base (NSObjectFlag.Empty)
		{
		...
		[CompilerGenerated]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		public QBMPushTokenAnswer (NSObjectFlag t) : base (t)
		{
			IsDirectBinding = GetType ().Assembly == global::ApiDefinition.Messaging.this_assembly;
		}
		...
		[CompilerGenerated]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		public QBMPushTokenAnswer (IntPtr handle) : base (handle)
		{
			IsDirectBinding = GetType ().Assembly == global::ApiDefinition.Messaging.this_assembly;
		}
