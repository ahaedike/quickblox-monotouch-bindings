...
namespace QuickBlox {
	...
	public unsafe partial class RestAnswer : Answer {
		...
		public virtual RestAnswerKind Kind {
			...
			get {
				if (IsDirectBinding) {
					return (RestAnswerKind) MonoTouch.ObjCRuntime.Messaging.UInt32_objc_msgSend (this.Handle, selKindHandle);
				} else {
					return (RestAnswerKind) MonoTouch.ObjCRuntime.Messaging.UInt32_objc_msgSendSuper (this.SuperHandle, selKindHandle);
				}
			}
