...
namespace QuickBlox {
	...
	public unsafe partial class QBLLocationDataSource : NSObject {
		...
		[CompilerGenerated]
		public virtual float DesiredAccuracy {
			[Export ("setDesiredAccuracy:")]
			set {
				if (IsDirectBinding) {
					MonoTouch.ObjCRuntime.Messaging.void_objc_msgSend_float (this.Handle, selSetDesiredAccuracy_Handle, value);
				} else {
					MonoTouch.ObjCRuntime.Messaging.void_objc_msgSendSuper_float (this.SuperHandle, selSetDesiredAccuracy_Handle, value);
				}
			}
		}
		
		[CompilerGenerated]
		public virtual float DistanceFilter {
			[Export ("setDistanceFilter:")]
			set {
				if (IsDirectBinding) {
					MonoTouch.ObjCRuntime.Messaging.void_objc_msgSend_float (this.Handle, selSetDistanceFilter_Handle, value);
				} else {
					MonoTouch.ObjCRuntime.Messaging.void_objc_msgSendSuper_float (this.SuperHandle, selSetDistanceFilter_Handle, value);
				}
			}
		}
