...
namespace QuickBlox {
	[Register("QBCOPermissionsAnswer", true)]
	public unsafe partial class QBCOPermissionsAnswer : XmlAnswer {
		[CompilerGenerated]
		const string selPermissions = "permissions";
		static readonly IntPtr selPermissionsHandle = Selector.GetHandle ("permissions");
		
		[CompilerGenerated]
		static readonly IntPtr class_ptr = Class.GetHandle ("QBCOPermissionsAnswer");
		...
		[Export ("init")]
		public QBCOPermissionsAnswer () : base (NSObjectFlag.Empty)
		{
		...
		public QBCOPermissionsAnswer (NSCoder coder) : base (NSObjectFlag.Empty)
		{
		...
		[CompilerGenerated]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		public QBCOPermissionsAnswer (NSObjectFlag t) : base (t)
		{
			IsDirectBinding = GetType ().Assembly == global::ApiDefinition.Messaging.this_assembly;
		}
		...
		[CompilerGenerated]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		public QBCOPermissionsAnswer (IntPtr handle) : base (handle)
		{
			IsDirectBinding = GetType ().Assembly == global::ApiDefinition.Messaging.this_assembly;
		}
