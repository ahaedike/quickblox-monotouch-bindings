...
namespace QuickBlox {
	[Register("QBMEventUpdateQuery", true)]
	public unsafe partial class QBMEventUpdateQuery : QBMEventQuery {
		[CompilerGenerated]
		...
		[CompilerGenerated]
		static readonly IntPtr class_ptr = Class.GetHandle ("QBMEventUpdateQuery");
		...
		[Export ("init")]
		public QBMEventUpdateQuery () : base (NSObjectFlag.Empty)
		{
		...
		public QBMEventUpdateQuery (NSCoder coder) : base (NSObjectFlag.Empty)
		{
		...
		[CompilerGenerated]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		public QBMEventUpdateQuery (NSObjectFlag t) : base (t)
		{
			IsDirectBinding = GetType ().Assembly == global::ApiDefinition.Messaging.this_assembly;
		}
		...
		[CompilerGenerated]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		public QBMEventUpdateQuery (IntPtr handle) : base (handle)
		{
			IsDirectBinding = GetType ().Assembly == global::ApiDefinition.Messaging.this_assembly;
		}
		...
		[CompilerGenerated]
		public QBMEventUpdateQuery (QBMEvent _event)
