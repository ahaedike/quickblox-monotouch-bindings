...
namespace QuickBlox {
	[Register("QBRScoreUpdateQuery", true)]
	public unsafe partial class QBRScoreUpdateQuery : QBRScoreQuery {
		[CompilerGenerated]
		...
		[CompilerGenerated]
		static readonly IntPtr class_ptr = Class.GetHandle ("QBRScoreUpdateQuery");
		...
		[Export ("init")]
		public QBRScoreUpdateQuery () : base (NSObjectFlag.Empty)
		{
		...
		public QBRScoreUpdateQuery (NSCoder coder) : base (NSObjectFlag.Empty)
		{
		...
		[CompilerGenerated]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		public QBRScoreUpdateQuery (NSObjectFlag t) : base (t)
		{
			IsDirectBinding = GetType ().Assembly == global::ApiDefinition.Messaging.this_assembly;
		}
		...
		[CompilerGenerated]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		public QBRScoreUpdateQuery (IntPtr handle) : base (handle)
		{
			IsDirectBinding = GetType ().Assembly == global::ApiDefinition.Messaging.this_assembly;
		}
		...
		[CompilerGenerated]
		public QBRScoreUpdateQuery (QBRScore _score)
